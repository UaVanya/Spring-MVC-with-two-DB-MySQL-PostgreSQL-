...
public class TestAreaType {
    ...
    /**
     * Checks the set value in Enum as String @see package.web.spring.entity.AreaType.class
     */
    @Test
    ...
    /**
     * Compares different values in Enum as String @see package.web.spring.entity.AreaType.class
     */
    ...
    /**
     * Compares value in Enum @see package.web.spring.entity.AreaType.class
     */
    @Test
